...
```bash
pip install https://github.com/anthonychu/copilot-functions/releases/download/v0.3.0/copilot_functions-0.3.0-py3-none-any.whl
```
...
```bash
# From release URL
pip install "copilot-functions[connectors] @ https://github.com/anthonychu/copilot-functions/releases/download/v0.3.0/copilot_functions-0.3.0-py3-none-any.whl"
...
```
https://github.com/anthonychu/copilot-functions/releases/download/v0.3.0/copilot_functions-0.3.0-py3-none-any.whl
```
